...
class RecentVideos extends StatelessWidget {
  ...
  Widget _buildVideoTile(BuildContext context, MediaFile video) {
    final isPublished = video.isPublished;
    ...
    return ListTile(
      ...
      subtitle: Column(
        ...
        children: [
          ...
          Text(
            '${video.fileSizeFormatted} · ${video.durationFormatted} · ${DateFormat('MM-dd HH:mm').format(video.createdAt)}',
      ...
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('点击了：${video.fileName}')),
        );
      },
    );
  }
